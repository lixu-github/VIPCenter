...
s.version      = "0.0.18"
  ...
  s.source       = { :git => "https://github.com/lixu-github/GameLive.git", :tag => s.version}#你的仓库地址，不能用SSH地址
  s.source_files = "GameLive/*.{h,m}" # 你代码的位置， BYPhoneNumTF/*.{h,m} 表示 BYPhoneNumTF 文件夹下所有的.h和.m文件
  s.requires_arc = true # 是否启用ARC
  s.public_header_files = 'GameLive/*.h'
  s.platform     = :ios, "8.0" #平台及支持的最低版本
  # s.frameworks   = "UIKit", "Foundation" #支持的框架
  s.dependency   = { 'React' => '0.29.2'}
  # User
